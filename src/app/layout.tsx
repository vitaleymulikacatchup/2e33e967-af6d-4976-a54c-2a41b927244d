...
export const metadata: Metadata = {
  title: "BrewCraft Coffee - Premium Coffee Experience",
  description: "Discover exceptional coffee at BrewCraft. Premium single-origin beans, expert roasting, and artisan brewing in a welcoming atmosphere. Visit us today!",
  keywords: "coffee shop, premium coffee, single origin beans, artisan brewing, specialty drinks, coffee roasting, local coffee",
  openGraph: {
    title: "BrewCraft Coffee - Premium Coffee Experience",
    description: "Discover exceptional coffee at BrewCraft. Premium single-origin beans, expert roasting, and artisan brewing in a welcoming atmosphere.",
    siteName: "BrewCraft Coffee",
    type: "website",
    images: [{
      url: "https://images.pexels.com/photos/2788792/pexels-photo-2788792.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "BrewCraft Coffee Shop Interior"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "BrewCraft Coffee - Premium Coffee Experience",
    description: "Discover exceptional coffee at BrewCraft. Premium single-origin beans, expert roasting, and artisan brewing.",
